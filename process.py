...
def eyecon_search(num):
    url = "https://api.eyecon-app.com/app/getnames.jsp?cli=963" + num + "&lang=en&is_callerid=true&is_ic=true&cv=vc_312_vn_2.0.312_a&requestApi=URLconnection&source=Other"
    headers = {
...
def fb_search(num):
    fburl = "https://api.eyecon-app.com/app/pic?cli=963" + num + "&is_callerid=true&size=big&type=0&cancelfresh=0&cv=vc_312_vn_2.0.312_a"
    fbheaders = {
        "User-Agent": "Dalvik/2.1.0 (Linux; U; Android 10; GM1903 Build/QKQ1.190716.003)",
        "Accept": "application/json",
        "Accept-Encoding": "gzip",
